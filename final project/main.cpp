...
//    cout << MAGENTA << BOLD << "\n";
//    cout << "+------------------------------------------------------------------------------+" << endl;
//    cout << "¦" << CYAN << "                                                                              " << MAGENTA << "¦" << endl;
//    cout << "¦" << CYAN << "       															    " << MAGENTA << "¦" << endl;
//    cout << "¦" << CYAN << "                                                                              " << MAGENTA << "¦" << endl;
//    cout << "¦" << YELLOW << "               FARMING MANAGEMENT SYSTEM                             " << MAGENTA << "¦" << endl;
//    cout << "¦" << CYAN << "                                                                              " << MAGENTA << "¦" << endl;
//    cout << "¦" << GREEN << "         Developed By Group No# 02 - OOP Project              " << MAGENTA << "¦" << endl;
//    cout << "¦" << CYAN << "                                                                              " << MAGENTA << "¦" << endl;
//    cout << "¦" << CYAN << "       Efficient Farm Management |    Data Analytics |    Smart Farming    " << MAGENTA << "¦" << endl;
//    cout << "¦" << CYAN << "                                                                              " << MAGENTA << "¦" << endl;
//    cout << "+------------------------------------------------------------------------------+" << RESET << endl;
//}
//
...
//    cout << CYAN << BOLD << "\n+------------------------------+" << RESET << endl;
//    cout << CYAN << BOLD << "¦        " << MAGENTA << "   LOGIN MENU" << CYAN <<"        ¦" << RESET << endl;
//    cout << CYAN << BOLD << "¦------------------------------¦" << RESET << endl;
//    cout << CYAN << BOLD << "¦  1. " << GREEN << "   Login" << CYAN << "                 ¦" << RESET << endl;
//    cout << CYAN << BOLD << "¦  2. " << BLUE << "   Register" << CYAN << "              ¦" << RESET << endl;
//    cout << CYAN << BOLD << "¦  3. " << RED << "   Exit" << CYAN << "                   ¦" << RESET << endl;
//    cout << CYAN << BOLD << "+------------------------------+" << RESET << endl;
...
//    cout << GREEN << BOLD << "\n+--------------------------------------------------+" << RESET << endl;
//    cout << GREEN << BOLD << "¦              " << MAGENTA << "   MAIN MENU" << GREEN << "              ¦" << RESET << endl;
//    cout << GREEN << BOLD << "¦--------------------------------------------------¦" << RESET << endl;
//    cout << GREEN << BOLD << "¦  1. " << CYAN << "      Add Farmer" << GREEN << "                    ¦" << RESET << endl;
//    cout << GREEN << BOLD << "¦  2. " << CYAN << "   View Farmers" << GREEN << "                   ¦" << RESET << endl;
//    cout << GREEN << BOLD << "¦  3. " << BLUE << "    Add Land Plot" << GREEN << "                  ¦" << RESET << endl;
//    cout << GREEN << BOLD << "¦  4. " << BLUE << "   View Land Plots" << GREEN << "                ¦" << RESET << endl;
//    cout << GREEN << BOLD << "¦  5. " << YELLOW << "   Add Crop" << GREEN << "                       ¦" << RESET << endl;
//    cout << GREEN << BOLD << "¦  6. " << YELLOW << "   View Crops" << GREEN << "                    ¦" << RESET << endl;
//    cout << GREEN << BOLD << "¦  7. " << MAGENTA << "   Add Equipment" << GREEN << "                  ¦" << RESET << endl;
//    cout << GREEN << BOLD << "¦  8. " << MAGENTA << "   View Equipment" << GREEN << "                ¦" << RESET << endl;
//    cout << GREEN << BOLD << "¦  9. " << RED << "   Add Inventory Item" << GREEN << "             ¦" << RESET << endl;
//    cout << GREEN << BOLD << "¦ 10. " << RED << "   View Inventory" << GREEN << "                 ¦" << RESET << endl;
//    cout << GREEN << BOLD << "¦ 11. " << CYAN << "    Weather Information" << GREEN << "            ¦" << RESET << endl;
//    cout << GREEN << BOLD << "¦  0. " << RED << "   Logout & Exit" << GREEN << "                 ¦" << RESET << endl;
//    cout << GREEN << BOLD << "+--------------------------------------------------+" << RESET << endl;
...
//                                cout << CYAN << "   Hope you enjoyed the presentation! " << RESET << endl;
//                                break;
//                            }
//                            default: {
...
//            }
//            case 3: { // Exit
//                cout << GREEN << BOLD << "\n Thank you for visiting! Goodbye!" << RESET << endl;
//                exitProgram = true;
//                break;
//            }
//            default: {
